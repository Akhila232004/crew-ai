...
After the API key is created, click the **Copy** button and save the key somewhere secure.
...
After clicking **Done**, your newly created API key will appear in the **Active keys** list.
...
Open the OpenRouter platform and click **Sign Up** if you do not already have an account.
...
After signing up, read and accept the Terms of Service, Privacy Policy, and Model Terms by selecting the checkbox.
...
OpenRouter may ask you to add a payment method.
...
Once your workspace setup is complete, you will see the **You're all set!** message.
...
From the left-side navigation menu, select **API Keys**.
